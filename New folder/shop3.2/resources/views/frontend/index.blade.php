 ...
 <section class="mb-4">
    <div class="container">
        <div class="">
            <div class="section-title-1 clearfix">
                <h3 class="heading-5 strong-700 mb-0 float-left">
                    <span class="mr-4">{{__('just for you')}}</span>
                </h3>
            </div>

            <div class=" arrow-round gutters-5">
                <div class="row">
                    @foreach ($product_jast_for_you as $key => $product)
                    <div class="col-6 col-md-3 col-lg-2dot4">
                        <div class="">
                            <div class="">

                                <div class="card-image card-image_jfy">
                                    <a href="{{ route('product', $product->slug) }}" class="d-block">
                                       <img class="img-fit lazyload mx-auto" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($product->thumbnail_img) }}" alt="{{ __($product->name) }}">
                                    </a>
                                </div>
