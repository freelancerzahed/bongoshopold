...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	// pin Code
	Route::get('pin-codes','PinCodeController@index')->name('pin_code');\
	Route::get('pin-codes/create','PinCodeController@create')->name('pin_code.create');
	Route::post('pin-codes/store','PinCodeController@store')->name('pin_code.store');
	Route::post('pin-codes/import','PinCodeController@pinImport')->name('pin_code.import');
	Route::get('pin-codes/edit/{id}','PinCodeController@edit')->name('pin_code.edit');
	Route::post('pin-codes/update/{id}','PinCodeController@update')->name('pin_code.update');
	Route::get('pin-codes/destroy/{id}','PinCodeController@destroy')->name('pin_code.destroy');
