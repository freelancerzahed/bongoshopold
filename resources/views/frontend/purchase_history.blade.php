                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                @if( ucfirst(str_replace('_', ' ', $order->orderDetails->first()->delivery_status))=='Pending'||'On review ' && $order->payment_status != 'paid')
                                                                    <a href="{{ route('purchase_history.destroy', $order->id) }}" class="dropdown-item">{{ translate('cancel Order ')}}</a>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </td>
