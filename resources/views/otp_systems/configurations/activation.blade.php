        ...
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">{{__('SMS Alert OTP')}}</h3>
                </div>
                <div class="panel-body text-center">
                    <label class="switch">
                        <input type="checkbox" onchange="updateSettings(this, 'sms_alert')" @if(\App\OtpConfiguration::where('type', 'sms_alert')->first()->value == 1) checked @endif>
