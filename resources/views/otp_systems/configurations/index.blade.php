        ...
        <div class="col-lg-6">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">{{__('SMS Alert Credential')}}</h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="sms_alert">
                        @csrf
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="SMSALERT_USER">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('SMSAlert User')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="SMSALERT_USER" value="{{  env('SMSALERT_USER') }}" placeholder="SMS ALERT USER" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="SMSALERT_PWD">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('SMSALERT PASSWORD')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="SMSALERT_PWD" value="{{  env('SMSALERT_PWD') }}" placeholder="SMSALERT PASSWORD " required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <select class="demo-select2" name="ROUTE" required>
                                    ...
                                    <option value="s" @if (env('ROUTE') == "s") selected @endif>BULK SMS</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
