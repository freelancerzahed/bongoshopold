...
@if(Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions)))
                        <li>
                            ...
                            <i class="fa fa-map-pin" aria-hidden="true"></i>
                                <span class="menu-title">{{translate('Pin Code')}}</span>
                                <i class="arrow"></i>
                            </a>

                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['pin_code'])}}">
                                    <a class="nav-link" href="{{route('pin_code')}}">{{translate('All Pin Code')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['pin_code.create'])}}">
                                    <a class="nav-link" href="{{route('pin_code.create')}}">{{translate('Add New')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
